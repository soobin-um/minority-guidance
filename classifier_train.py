...
def main():
    ...
    logger.log("loading feature extractor for implementing a cascaded minority classifier...")
    ...
    def forward_backward_log(data_loader, prefix="train"):
        ...
        for i, (sub_batch, sub_labels, sub_t) in enumerate(
            ...
            latents = f_extractor(sub_batch, timesteps=sub_t, f_out=True)
            logits = model(latents, timesteps=sub_t)
